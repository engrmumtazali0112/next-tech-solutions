...
| `GET` | `/api/v1/contact/messages/{id}` | Get message by ID | 🔒 |
...
curl -X POST https://your-api.railway.app/api/v1/contact/ \
  ...
  -d '{
    ...
    "message": "I need an AI chatbot for my SaaS platform.",
...
<details>
<summary><b>📋 ContactMessage</b></summary>
